...
class PackageDetail extends StatelessWidget {
  ...
  const PackageDetail(this.id, this.image, this.message, this.name, this.no, this.status, this.token);
      ...
      child: InkWell(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => ArtDetail(id, image, message, name, no, status, token)
              ));
            },
            child: ListTile(
